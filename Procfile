...
# consul: consul agent -node=nassiel -bind=0.0.0.0 -data-dir=/Users/user/code/demo-system/consul-data -client=10.94.1.37 -ui
consul: consul agent -node=nassiel -dev
# vault: cd /Users/user/servers/vault && vault server start && vault operator unseal AJd4bPLauYyEctacJlyEp1Yt1lJgeMKR5OYKd5NkEDA=
